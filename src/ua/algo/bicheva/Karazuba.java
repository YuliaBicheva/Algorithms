...
/**
 * Class realize Karazuba algorithm based on array
 */
public class Karazuba implements Serializable{
    ...
    /**
     * Initialize Karazuba object by integer value
     * @param intValue
     */
    ...
    /**
     * Initialize Karazuba object by String value
     * @param str
     */
    public Karazuba(String str){
        int[] tmp = new int[str.length()];
        for(int i = 0; i < str.length(); i++)
            tmp[i] = Integer.parseInt(str.substring(i, i+1));
     ...
     * @param array
     */
    public Karazuba(int[] array) {

        this.value = array.length == 0 ? new int[]{0} : array;
    }
    ...
    /**
     * Multiply current karazuba number with another
     * @param anotherValue Karazuba object
     * @return
     */
